package net.kandetvaraeddan.tutorialmod.entity.custom;
...
public class Raccoon extends TamableAnimal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    private static final EntityDataAccessor<Boolean> SITTING =
            SynchedEntityData.defineId(Raccoon.class, EntityDataSerializers.BOOLEAN);

    public Raccoon(EntityType<? extends TamableAnimal> entityType, Level level) {
